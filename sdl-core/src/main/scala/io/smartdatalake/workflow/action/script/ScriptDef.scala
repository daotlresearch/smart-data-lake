...
trait ScriptDef {
   ...
   */
  def execStdOutString(configObjectId: ConfigObjectId, partitionValues: Seq[PartitionValues], parameters: Map[String,String], errors: mutable.Buffer[String] = mutable.Buffer())(implicit session: SparkSession, context: ActionPipelineContext): String
   ...
   */
  def execStdOutStream(configObjectId: ConfigObjectId, partitionValues: Seq[PartitionValues], parameters: Map[String,String], errors: mutable.Buffer[String] = mutable.Buffer())(implicit session: SparkSession, context: ActionPipelineContext): Stream[String]
}
